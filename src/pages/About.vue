          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-5 ml-auto">
                <div
                  class="card card-background card-background-product card-raised sec-img"
                >
                  <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-5 mr-auto">
                <div
                  class="card card-background card-background-product card-raised third-img"
                >
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="dropdown bootstrap-select">
                          <select
                            class="selectpicker"
                            data-size="7"
                            data-style="btn btn-default btn-round mt-0"
                            title="Speciality"
                            tabindex="-98"
                            ><option class="bs-title-option" value=""></option>
                            <option value="1">I'm a Designer</option>
                            <option value="2">I'm a Developer</option>
                            <option value="3">I'm a Hero</option> </select
                          ><button
                            type="button"
                            class="dropdown-toggle bs-placeholder btn btn-default btn-round mt-0"
...
.main-img {
  ...
  /* transform: translate3d(0px, 166.667px, 0px); */
  background-size: cover;
}

.sec-img {
  background-image: url('../assets/img/project8.jpg')
}

.third-img {
  background-image: url('../assets/img/project9.jpg')
}
</style>